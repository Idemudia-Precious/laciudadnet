...
<div class="card-body cbody">
                ...
                <div class='card card1' >
                    ...
                    <ul class="list-unstyled">
                        ...
                        <div class="media">
                            <img class="mr-3 medimag rounded-circle shadow-sm" src="image/place.png" alt="image">
                            <div class="media-body mediabody1">
                            <a href='profile'>Julianna Pierce</a>
                            <div class="truc2 pb-3">Fashion Designer
                                <span class="ml-2 text-muted bus-span-globe-time">. 18 hrs <i class='mdi mdi-earth'> </i></span>
                            </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="tag">
                            <img src="image/coke.jpg" class="img-responsive" style="width: 100%;">
                            <span class="product-discount-label3">$8.00</span>
                            </div>
                        </div><!--end row-->
                ...
                <div class='card card1' >
                    ...
                    <ul class="list-unstyled">
                        ...
                        <div class="media">
                            ...
                            <!--product title-->
                            <p class="pclass">Cras sit amet nibh libero, in gravida nulla.</p>
                        ...
                        <div class="row">
                            <div class="tag">
                            <img src="image/bus.jpg" class="img-responsive" style="width: 100%;">
                            <span class="product-discount-label4">$3.00</span>
                            </div>
                            ...
                            <!--icons-->
                                ...
                                <span class="cardbox-base">
                                    ...
                                    <ul class="cardbox-ul" >
                                    <span class='mainp'>
                                        <a href="" title="like" class="mainpp shadow-sm"><i class='mdi mdi-thumb-up'></i></a></span>

                                    <li class="cardbox-li"><a href="#"><img src="image/user.jpg" class="img-fluid rounded-circle shadow-sm" alt="User"></a></li>
                                    <li class="cardbox-li"><a href="#"><img src="image/user2.jpg" class="img-fluid rounded-circle shadow-sm" alt="User"></a></li>
                                    <li class="cardbox-li"><a href="#"><img src="image/lablady.jpg" class="img-fluid rounded-circle shadow-sm" alt="User"></a></li>
                                    <li class="cardbox-li"><a href="#"><img src="image/user.jpg" class="img-fluid rounded-circle shadow-sm" alt="User"></a></li>
                                    <li class="cardbox-li"><a><span class="" data-toggle="modal" data-target="">100 likes</span></a></li>
                                    </ul>
                                </span><!--/ cardbox-base-->
                                </div>
                            </div>
                ...
                <div class='card card1' >
                    ...
                    <ul class="list-unstyled">
                        ...
                        <div class="row">
                            <div class="tag">
                            <img src="image/lipstick.jpg" class="img-responsive" style="width: 100%;">
                            </div>
                            ...
                            <!--icons-->
                                ...
                                <span class="cardbox-base">
                                    ...
                                    <ul class="cardbox-ul" >
                                    <span class='mainp'>
                                        <a href="" title="like" class="mainpp shadow-sm"><i class='mdi mdi-thumb-up'></i></a>
                                        <a href="" title="cart" class="cart-likes shadow-sm"><i class='fa fa-cart-plus'></i></a>
                                    </span>
                                    ...
                                    <li class="cardbox-li"><a href="#"><img src="image/lablady.jpg" class="img-fluid rounded-circle shadow-sm" alt="User"></a></li>
                                    <li class="cardbox-li"><a href="#"><img src="image/user.jpg" class="img-fluid rounded-circle shadow-sm" alt="User"></a></li>
                                    <li class="cardbox-li"><a><span class="" data-toggle="modal" data-target="">16 likes</span></a></li>
                                    </ul>
                                </span><!--/ cardbox-base-->
                                </div>
                            </div>
                ...
                <div class='card card1' >
                    ...
                    <ul class="list-unstyled">
                        ...
                        <div class="media">
                            <img class="mr-3 medimag rounded-circle shadow-sm" src="image/place.png" alt="image">
                            <div class="media-body mediabody1">
                            <a href='profile'>Spring beauty care</a>
                            <div class="truc2 pb-3">Fashion Designer
                                <span class="ml-2 text-muted bus-span-globe-time">. 18 hrs <i class='mdi mdi-earth'> </i></span>
                            </div>
                            <p class="pclass">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio.</p>
                ...
                <div class='card card1' >
                    ...
                    <ul class="list-unstyled">
                        ...
                        <div class="media">
                            <img class="mr-3 medimag rounded-circle shadow-sm" src="image/place.png" alt="image">
                            <div class="media-body mediabody1">
                            <a href='profile'>SERP Digitals</a>
                            <div class="truc2 pb-3">Fashion Designer
                                <span class="ml-2 text-muted bus-span-globe-time">. 18 hrs <i class='mdi mdi-earth'> </i></span>
                            </div>
                            </div>
                        ...
                        <div class="mySlides">
                            ...
                            <a class="preev" onclick="plusSlides(-1)">&#10094;</a>
                            <a class="neext" onclick="plusSlides(1)">&#10095;</a>

                            <!-- Thumbnail images-->
                            <div class="column">
                                <img class="demo cursor plentyimg" src="image/digital.jpg" onclick="currentSlide(1)" alt="image">
                            </div>
                            <div class="column">
                                <img class="demo cursor plentyimg" src="image/lipstick.jpg" onclick="currentSlide(2)" alt="image">
                            </div>
                            <div class="column">
                                <img class="demo cursor plentyimg" src="image/read.jpg" onclick="currentSlide(3)" alt="image">
                            </div>
                            <div class="column">
                                <img class="demo cursor plentyimg" src="image/campaig.jpg"onclick="currentSlide(4)" alt="image">
                            </div>
                            <div class="column">
                                <img class="demo cursor plentyimg" src="image/evolution.jpg" onclick="currentSlide(5)" alt="image">
                            </div>
                            <div class="column">
                                <img class="demo cursor plentyimg" src="image/slide.jpg" onclick="currentSlide(6)" alt="image">
                            </div>
                            <div class="container iconcont">
                            <!--icons-->
                            <div class="mainicons">
                                <span class="cardbox-base">
                                    ...
                                    <li class="cardbox-li"><a href="#"><img src="image/lablady.jpg" class="img-fluid rounded-circle shadow-sm" alt="User"></a></li>
                                    <li class="cardbox-li"><a href="#"><img src="image/user.jpg" class="img-fluid rounded-circle shadow-sm" alt="User"></a></li>
                                    <li class="cardbox-li"><a><span class="" data-toggle="modal" data-target="">6k likes</span></a></li>
                ...
                <div class='card card1' >
                    <div class="card-body cbody">
                    <ul class="list-unstyled">
                            <li class="dropdown pull-right dp">
                            <span href="#" class='mainh'>
                                Sponsored
                            </span>
                            </li>
                        </ul>
                        ...
                        <p class="pclass">
                                Use ID, Identity & Document Verification To Meet KYC, AML & GDPR Compliance. Fight Fraud & Onboard Customers, Faster With Netverify® AI-powered Identity Verification.
                            </p>

                        <!-- post image-->
                        <div class="row">
                            <div class="tag">
                            <img src="image/evolution.jpg" class="img-responsive" style="width: 100%;">
                            </div>
                            <section class="sp">
                            <div class='sponsor'>
                                <div class='spon'>
                                ...
                                <button type='button' class='btn btn-light btn-sm'>Learn More</button>
                                </div><!--end spon-->
                            </div><!--end sponsor-->
                            </section>
                            ...
                            <!--icons-->
                                ...
                                <span class="cardbox-base">
                                    ...
                                    <li class="cardbox-li"><a href="#"><img src="image/lablady.jpg" class="img-fluid rounded-circle shadow-sm" alt="User"></a></li>
                                    <li class="cardbox-li"><a href="#"><img src="image/user.jpg" class="img-fluid rounded-circle shadow-sm" alt="User"></a></li>
                                    <li class="cardbox-li"><a><span class="" data-toggle="modal" data-target="">SERP digitals and 7 others</span></a></li>
